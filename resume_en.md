...
* ### &nbsp;&nbsp; 第二职责 (2017/01 - 2018/04) -- **GEAR China PAS 创新组长(12人)**
* ### &nbsp;&nbsp; 第二职责 (2018/04 - 至今) -- **GEAR China 创新组长(24人)**
#### 主要职责
...
* ### 2017/6 - 2017/12 -- &nbsp;&nbsp; **Baidu RNN Workloads Optimization On Xeon**
...
* ### 2018/01 - 2018/02 -- &nbsp;&nbsp; **[Heartbeat Sounds](https://www.kaggle.com/kinguistics/heartbeat-sounds)**
#### 证明在相同的算法下，单纯提高样本的采样分辨率是否有益于肺结节检测精度。 网络使用 Res18net做特征提取，并且训练了一个RPN (PyTorch) 用于搜索结节的proposal，移植 PyTorch 版本的网络到 Intel Caffe（KNL支持384G内存）上测试不同的分辨率 (64, 128, 192) 的精度，精准度和召回率。
...
## **工作经历**
----------
* ### 2015/06 - Now -- &nbsp;&nbsp; **英特尔亚太研发有限公司** &nbsp;&nbsp; Flex 
* ### &nbsp;&nbsp; (2015/06 - 2017/05) -- **软件开发工程师** &nbsp;&nbsp; (2017/05 - 至今) -- **机器学习工程师**
* ### &nbsp;&nbsp; (2017/01 - 2018/04) -- **GEAR China PAS 创新组长(12人)** (2018/04 - 至今) -- **GEAR China 创新组长(24人)**
#### 主要职责
